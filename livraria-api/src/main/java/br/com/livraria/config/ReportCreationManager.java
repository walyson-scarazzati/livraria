...
public class ReportCreationManager {
    public static String generateReport(List<Usuario> usuarioList, OutputStream outputStream) throws JRException, FileNotFoundException {
        String templateFile = ResourceUtils.getFile(ResourceUtils.CLASSPATH_URL_PREFIX + "usuarioDetails.jsxml").getAbsolutePath();
